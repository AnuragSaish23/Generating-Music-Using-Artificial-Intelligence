...
class MarkovChainMelodyGenerator:
    ...
    def __init__(self, states):
        """
        Initialize the Markov Chain with a list of states.

        Parameters:
        - states( list of tuples): A list of possible (pitch, duration) pairs.
        """
    ...
    def train(self, notes):
        """
        Train the model based on the list of notes.
    ...
    def generate(self, length):
        """
        Generate a melody of given length
    ...
    def _normalize_initial_probabilities(self):
        """
        Normalize the initial probalities array such that the sum of all probabilites equals 1.
        """
...
def main():
    ...
    print("Initial Probabilites:", model.initial_probabilities)
